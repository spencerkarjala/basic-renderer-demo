...
all: ./src/FruitTetris.cpp
	$(CC) $(CCFLAGS) $(FNAME) ./src/FruitTetris.cpp ./src/BoardMediator.cpp ./src/Board.cpp ./src/Fruit.cpp ./src/Renderer.cpp $(TETROMINOES) ./src/GameInstance.cpp ./src/Space3D.cpp ./src/WorldObject.cpp ./src/Grid.cpp ./src/Shader.cpp ./src/Camera.cpp ./src/ObjReader.cpp $(LINKS)
